...
class Uploader extends Controller
{
    ...
    protected function upload_validate($uploaded_file, $file, $error, $index) {
        if ($error) {
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $file->type = $type;
        if ($this->upload_validate($uploaded_file, $file, $error, $index)) {
    ...
    protected function save_to_database($image_name, $hue){
        $image = new Images();
        $image->store($image_name, $hue);
    }
